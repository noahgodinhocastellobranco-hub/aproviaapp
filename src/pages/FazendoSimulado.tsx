    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-3">Fazendo um Simulado</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-primary/30 bg-gradient-to-br from-primary/5 to-primary/10">
              ...
              <CardContent className="space-y-6">
                {/* Timer Display */}
                <div className="bg-card rounded-xl p-12 text-center border border-primary/20">
                  <p className="text-sm text-muted-foreground mb-4 uppercase tracking-wider">
                    {isFinished ? "Tempo Esgotado" : isRunning ? "Tempo Restante" : "Tempo Total"}
                  </p>
                  <p className={`text-8xl md:text-9xl font-bold mb-6 font-mono ${getTimeColor()}`}>
                    {formatTime(timeLeft)}
                  </p>
